<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <button type="button" class="btn-tambah btn btn-warning" data-toggle="modal" data-target="#modalDiagnosa"><i class="fa fa-fw fa-plus"></i> Tambah</button>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa  fa-eye"></i> Diagnosa</a></li>
          </ol>
        </section>
      ...
      <!-- Modal -->
      <div class="modal fade modal-success" id="modalDiagnosa" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
