...
var obat = new Vue({
  ...
  ready: function(){
    ...
    this.getObat();
	this.timer = setInterval(this.getObat, 10000);
  },
  ...
  methods: {
    ...
    doneEdit: function(obat,index){
		...
		if(!obat.keterangan)
		{
			alert('Kolom keterangan edit harus diisi !');
		}
		else
		{
...
var karyawan = new Vue({
  ...
  ready: function(){
    this.getKaryawan();
	this.listProfesi();
	this.timer = setInterval(this.getKaryawan, 10000);
	this.timer = setInterval(this.listProfesi, 10000);
  },
